...
-- there is now way in inserting the data into the first row specifically
-- but we can cheat while playing with viewing the data, using select
...
-- we can ORDER BY using InvoiceDate column  
